#!/usr/bin/env python3
"""
Cari kartlarını Excel dosyasından DOĞRU SQLite veritabanına aktar
Backend'in kullandığı database dosyasına yaz
"""
...
# Veritabanı bağlantısı - Backend'in kullandığı dosya
